...
const MessageBus = require("./src/bus");
const errors = require("./src/errors");
const { Variant } = require("./src//variant");
const { Message } = require("./src/message-type.js");
const iface = require("./src/service/interface");
 ...
 */
module.exports.setBigIntCompat = require("./src/library-options").setBigIntCompat;
...
module.exports.validators = require("./src/validators");
